...
*install*  
language managers (rig)  
*install*  
language versions  (R-4.2 -e "install.packages('renv')`)  
*install*  
environment managers  `renv::install()`
*install*  
projects  

:::{.notes}
needs a diagram
? vertical arrow of generality
:::
...
Tools for freezing installations with your package manager are, in general, pretty bad
Other software that you install with your package manager may 
...
- [install rig](https://github.com/r-lib/rig/releases/)
- add image
