...
::: notes
Environment variables are inherited by child processes, so setting them early in the startup process is valuable
Hosting providers trying to deal with secrets will often let you supply environment variables
...
-   creating reproducible environments :arrow_left:
-   installing / upgrading R
...
-   starting R :white_check_mark:
-   installing R packages :white_check_mark:
-   creating reproducible environments :white_check_mark:
